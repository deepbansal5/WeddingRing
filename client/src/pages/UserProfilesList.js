        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">CurrentCity</TableCell>
              <TableCell align="right">DOB</TableCell>
              <TableCell align="right">FIrstName</TableCell>
              <TableCell align="right">Gotra</TableCell>
              <TableCell align="right">LastName</TableCell>
              <TableCell align="right">TimeOfBirth</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                ...
                <TableCell align="right">{ row.CurrentCity }</TableCell>
                <TableCell align="right">{ row.DOB }</TableCell>
                <TableCell align="right">{ row.FIrstName }</TableCell>
                <TableCell align="right">{ row.Gotra }</TableCell>
                <TableCell align="right">{ row.LastName }</TableCell>
                <TableCell align="right">{ row.TimeOfBirth }</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
